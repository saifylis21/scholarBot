...
const CardCollage = () => (
    <div className="w-full bg-slate-900 flex justify-center py-16 px-6">
        ...
        <Card isFooterBlurred className="w-full h-[300px] col-span-12 sm:col-span-5">
            <CardHeader className="absolute z-10 top-1 flex-col !items-start">
                <p className="text-tiny text-white/60 uppercase font-bold">ScholarBot</p>
        ...
        <Card isFooterBlurred className="w-full h-[300px] col-span-12 sm:col-span-7">
            ...
            <CardFooter className="absolute bg-black/40 bottom-0 z-10 border-t-1 border-default-600 dark:border-default-100">
                <p className="text-tiny text-white/60">ScholarBot App<br/>Your Personal AI Teacher.</p>
            </CardFooter>
        </Card>
        </div>
    </div>
